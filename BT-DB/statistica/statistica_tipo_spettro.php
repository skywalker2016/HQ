...
?>
		<tr> 
			...
			<td width='50%' id='font3' bgcolor="#006699"><font color='#FFFFCC'># SVS spectrum</font>
			</td>
			<td width='40%' id='form2'>
			<?php print ("$n_1");?>
			</td>
		...
		<tr> 
			...
			<td width='50%' id='font3' bgcolor="#006699"><font color='#FFFFCC'># CSI spectrum </font>
			</td>
			<td width='40%' id='form2'>
			<?php print ("$n_2");?>
			</td>
