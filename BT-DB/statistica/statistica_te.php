...
?>
		<tr> 
			...
			<td width='50%' id='font3' bgcolor="#006699"><font color='#FFFFCC'># TE short </font>
			</td>
			<td width='40%' id='form2'>
			<?php print ("$n_1");?>
			</td>
		...
		<tr> 
			...
			<td width='50%' id='font3' bgcolor="#006699"><font color='#FFFFCC'># TE intermediate </font>
			</td>
			<td width='40%' id='form2'>
			<?php print ("$n_2");?>
			</td>
		...
		<tr> 
			...
			<td width='50%' id='font3' bgcolor="#006699"><font color='#FFFFCC'># TE long </font>
			</td>
			<td width='40%' id='form2'>
			<?php print ("$n_3");?>
			</td>
...
for ($i=0; $i<$n_pazienti; $i++)
{
	...
	$rm = new rm_spettroscopica ($id_paz, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	...
	if ($val_dif == 'breve')
		$val_dif = 'Short';
	if ($val_dif == 'intermedio')
		$val_dif = 'Intermediate';
	if ($val_dif == 'lungo')
		$val_dif = 'Long';			
