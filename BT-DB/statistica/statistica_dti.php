...
<tr> 
	...
	<td width='50%' id='font3' bgcolor="#006699"><font color='#FFFFCC'>Number of patients with RM DTI</font></td>
...
<tr> 
	...
	<td width='50%' id='font3' bgcolor="#006699"><font color='#FFFFCC'># Compressed </font>
	</td>
	<td width='40%' id='form2'>
	<?php print ("$n_on");?>
	</td>
...
<tr> 
	...
	<td width='50%' id='font3' bgcolor="#006699"><font color='#FFFFCC'># Infiltrated </font>
	</td>
	<td width='40%' id='form2'>
	<?php 
