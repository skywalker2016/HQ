...
{	
	...
	$query = "SELECT id_paziente FROM esame_tc WHERE tipo_contrasto = '$var_1[$i]' ";
	...
	{
		if ($var_1[$i] == 'disomogeneo')
			$var_2 = 'Inhomogeneous';
		if ($var_1[$i] == 'omogeneo')
			$var_2 = 'Homogeneous ';
		if ($var_1[$i] == 'ad_anello')
			$var_2 = 'Ring';						
	
		print ("
			<tr> 
			<td width='10%' id='font3' bgcolor='#006699' align='center'><font color='#FFFFCC'>$i</font></td>
			<td width='50%' id='font3' bgcolor='#006699'><font color='#FFFFCC'>Pazients with: $var_2</font></td>
			<td width='40%' id='form2'>
