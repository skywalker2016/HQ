...
<?php
for ($i=0; $i<$n_reparto; $i++)
{	

	// recupera il numero di pazienti di quel reparto:
	$query = "SELECT id FROM patient WHERE reparto_provenienza = '$reparto[$i]' ";
	...
	else
	{
		print ("
			...
			<td width='50%' id='font3' bgcolor='#006699'><font color='#FFFFCC'>From $reparto[$i]</font></td>
			<td width='40%' id='form2'>
			$n3
			</td>
			</tr>
